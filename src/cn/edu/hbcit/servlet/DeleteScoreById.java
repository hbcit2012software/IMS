 ...
 * 2014-6-24
 */
public class DeleteScoreById extends HttpServlet {
	protected final Logger log = Logger.getLogger(DeleteScoreById.class.getName());
	/**
	 * Constructor of the object.
	 */
	public DeleteScoreById() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//判断是否删除文件
				if(fileFlag){
					...
					flag = cd.deleteScore(Integer.parseInt(id));
					}
					if(flag)
					{
						request.setAttribute("msg", "删除成功");
						request.getRequestDispatcher("ScoreServlet").forward(request, response);
					}
					else
					{
