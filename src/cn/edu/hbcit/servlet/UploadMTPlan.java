...
public class UploadMTPlan extends HttpServlet {
...
//		PrintWriter out = response.getWriter();
		...
		flag = cd.uploadMidTermPlan(course_id, path);
		if(flag){
		request.setAttribute("msg", "上传成功");
		request.getRequestDispatcher("MidTermPlan").forward(request, response);
		}
		else{
