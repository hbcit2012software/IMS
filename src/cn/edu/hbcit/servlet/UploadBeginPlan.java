 ...
 * 2014-6-21
 */
public class UploadBeginPlan extends HttpServlet {
	protected final Logger log = Logger.getLogger(UploadBeginPlan.class.getName());
	private ServletConfig config;
	/**
	 * Constructor of the object.
	 */
	public UploadBeginPlan() {
		super();
	}
...
//		PrintWriter out = response.getWriter();
		...
		flag = cd.uploadBeginPlan(course_id, path);
		if(flag){
