 ...
 * 2014-6-24
 */
public class UploadPracticePlan extends HttpServlet {
	protected final Logger log = Logger.getLogger(UploadPracticePlan.class.getName());
	private ServletConfig config;

	/**
	 * Constructor of the object.
	 */
	public UploadPracticePlan() {
		super();
	}
...
//		PrintWriter out = response.getWriter();
		...
		flag = cd.uploadPracticePlan(course_id, path);
		if(flag){
