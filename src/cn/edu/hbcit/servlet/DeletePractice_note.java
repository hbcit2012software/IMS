 ...
 * 2014-6-24
 */
public class DeletePractice_note extends HttpServlet {
	protected final Logger log = Logger.getLogger(DeletePractice_note.class.getName());
	/**
	 * Constructor of the object.
	 */
	public DeletePractice_note() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//判断是否删除文件
				if(fileFlag){
					...
					flag = cd.deletePractice_note(Integer.parseInt(id));
					}
					if(flag)
					{
