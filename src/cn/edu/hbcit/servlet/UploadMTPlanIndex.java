...
public class UploadMTPlanIndex extends HttpServlet {
	protected final Logger log = Logger.getLogger(UploadMTPlan.class.getName());
	private ServletConfig config;
	/**
	 * Constructor of the object.
	 */
	public UploadMTPlanIndex() {
		super();
	}
...
//		PrintWriter out = response.getWriter();
		...
		flag = cd.uploadMidTermPlanIndex(course_id, path);
		if(flag){
		request.setAttribute("msg", "上传成功");
		request.getRequestDispatcher("MidTermPlanIndex").forward(request, response);
		}
		else{
