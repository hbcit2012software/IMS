 ...
 * 2014-6-24
 */
public class PracticeMissionNoteServlet extends HttpServlet {
	protected final Logger log = Logger.getLogger(PracticeMissionNoteServlet.class.getName());

	/**
	 * Constructor of the object.
	 */
	public PracticeMissionNoteServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/2_2_8.jsp").forward(request, response);
	}
