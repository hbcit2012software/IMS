...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"每页显示 _MENU_ 条记录",sZeroRecords:"No matching records found",sInfo:"第 _START_ 至 _END_ 条,共 _TOTAL_ 条",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sSearch:"Search:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"}};
