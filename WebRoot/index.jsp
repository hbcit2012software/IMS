...
<body>
	...
	<header id="top">
		<div class="wrapper-login">
			...
			<!-- Aside links -->
			<aside><b>Welcome to</b> &middot; <a href="#">Instructional Management System</a></aside>
			<!-- End of Aside links -->
		</div>
	</header>
	<!-- End of Header -->
		...
		<div class="wrapper-login">
				...
				<section class="full">					
					...
					<form id="loginform" method="post" action="main.jsp">
						...
						<p>
							<input type="submit" class="btn btn-green big" value="登  录"/> &nbsp; <a href="javascript: //;" onClick="$('#emailform').slideDown(); return false;">忘记密码</a> or <a href="#">在线帮助</a>
						</p>
						<div class="clear">&nbsp;</div>
	...
	<footer id="bottom">
		<div class="wrapper-login">
			<p>Copyright &copy; 2014 HBCIT.EDU<b></p>
		</div>
	</footer>
	<!-- End of Page footer -->
