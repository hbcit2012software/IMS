	...
	<div id="page">
		...
		<div class="wrapper">
		  ...
		  <section class="column width8">
		    <form id="sampleform"  name="kcid" ENCTYPE="multipart/form-data" method="post" action="${pageContext.request.contextPath }/servlet/UploadMTPlan">
		      <fieldset>
		        <legend>期中教案</legend>
		      ...
		      <table class="display stylized" id="example">
		        ...
		        <tbody>
		          ...
		          <tr>
		            ...
		            <td class="center">${fn:substringAfter(mct.mid_term_plan,"userfiles/")}</td>
		            <td class="center"><a href="${pageContext.request.contextPath }/${mct.mid_term_plan}" title="下载"><img width="16" height="16" alt="另存文件" src="${pageContext.request.contextPath }/img/page_save.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/servlet/DeleteMidPlanById?id=${mct.PK_course }" title="删除"><img src="${pageContext.request.contextPath }/img/cross.png" alt="删除" /></a></td>
	              </tr>
		        </c:forEach>
	            </tbody>
	          </table>
