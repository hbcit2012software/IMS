	...
	<div id="page">
		...
		<div class="wrapper">
		  ...
		  <section class="column width8">
		    <!--	<h3>新增教研室活动计划</h3>-->
		    <form id="sampleform"  name="kcid" method="post" action="${pageContext.request.contextPath }/servlet/UploadMidPPT" ENCTYPE="multipart/form-data">
		      <fieldset>
		        <legend>期中PPT</legend>
		      ...
		      <table class="display stylized" id="example">
		        ...
		        <c:forEach items="${requestScope.MajorCourseTerms}" var="mct">
		          <tr>
		            ...
		            <td class="center">${fn:substringAfter(mct.mid_term_ppt,"userfiles/")}</td>
		            <td class="center"><a href="${pageContext.request.contextPath }/${mct.mid_term_ppt}" title="下载"><img width="16" height="16" alt="另存文件" src="${pageContext.request.contextPath }/img/page_save.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/servlet/DeleteMidpptById?id=${mct.PK_course }&filename=${mct.begin_term_ppt}" title="删除"><img src="${pageContext.request.contextPath }/img/cross.png" alt="删除" /></a></td>
	              </tr>
		        </c:forEach>
	            </tbody>
	          </table>
