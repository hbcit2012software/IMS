	...
	<div id="page">
		...
		<div class="wrapper">
		  ...
		  <section class="column width8">
		    <!--	<h3>新增教研室活动计划</h3>-->
		    <form id="sampleform"  name="kcid" method="post" action="${pageContext.request.contextPath }/servlet/InsertHomeWorkServlet" >
		      <fieldset>
		        <legend>学生作业</legend>
		        <table class="no-style" width="100%">
		          ...
		          <tr>
		            <td colspan="4"><p class="box"> <span>课程名称：</span>
                    ...
                    <input type="hidden" value="CCCCCCC" name="test03">
		              <select id="kcid" name="selectkcid" style="width:150px;">
		                <c:forEach items="${requestScope.courseList}" var="major">
		              ...
		              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		              <input type="checkbox" style="width:auto;" name="homeworked">&nbsp;&nbsp;已经交作业
                      
		              <input type="submit" class="btn btn-green big" id="tijiao" value="确定"/>
		              </p></td>
	              </tr>
	            </table>
	          </fieldset>
		      ...
		      <table class="display stylized" id="example">
		        <thead>
		          <tr>
                    ...
                    <th width="45%"><div align="center">是否已交</div></th>
		        ...
		        <tbody>
		          ...
		          <tr>
		            ...
		            <td class="center"><c:if test="${mct.homework==0}"><img src="${pageContext.request.contextPath }/img/cancel.png" alt="Edit" /></c:if>
		            <c:if test="${mct.homework==1}"><img src="${pageContext.request.contextPath }/img/accept.png" alt="Edit" /></c:if>
		            </td>
		            <td class="center"><a href="${pageContext.request.contextPath }/servlet/updateHomeWorkServlet?id=${mct.PK_course}&hw=${mct.homework}" title="修改"><img src="${pageContext.request.contextPath }/img/pencil.png" alt="Edit" /></a>&nbsp;&nbsp;&nbsp;</td>
	              </tr>
		        </c:forEach>
	            </tbody>
	          </table>
...
<script type="text/javascript" SRC="${pageContext.request.contextPath }/js/administry.js"></script><FOOTER id="bottom">
</body>
</html>