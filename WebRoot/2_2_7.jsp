	...
	<div id="page">
		...
		<div class="wrapper">
		  ...
		  <section class="column width8">
		    <!--	<h3>新增教研室活动计划</h3>-->
		    <form id="sampleform"  name="kcid" method="post" action="${pageContext.request.contextPath }/servlet/UpdatePractice_note" ENCTYPE="multipart/form-data">
		      <fieldset>
		        <legend>实践指导书</legend>
		      ...
		      <table class="display stylized" id="example">
		        <thead>
		          <tr>
                    ...
                    <th width="45%"><div align="center">实践指导书附件</div></th>
		        ...
		        <c:forEach items="${requestScope.MajorCourseTerms}" var="mct">
		          <tr>
		            ...
		            <td class="center">${fn:substringAfter(mct.practice_note,"userfiles/")}</td>
		            <td class="center"><a href="${mct.practice_note}" title="下载"><img width="16" height="16" alt="另存文件" src="${pageContext.request.contextPath }/img/page_save.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/servlet/DeletePractice_note?id=${mct.PK_course }&filename=${mct.practice_note}" title="删除"><img src="${pageContext.request.contextPath }/img/cross.png" alt="删除" /></a></td>
	              </tr>
		        </c:forEach>
	            </tbody>
	          </table>
